...
export interface ApiActivityTemplateActivityTemplate
  ...
  attributes: {
    authorizedFacilitators: Schema.Attribute.Relation<
      'manyToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    standardDuration: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiFacilitatorFacilitator extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authorizedActivities: Schema.Attribute.Relation<
      'manyToMany',
      'api::activity-template.activity-template'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    globalOpeningEnd: Schema.Attribute.Date & Schema.Attribute.Required;
    globalOpeningStart: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weeklyClosures: Schema.Attribute.JSON;
  };
}
